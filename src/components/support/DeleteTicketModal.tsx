...
const DeleteTicketModal = ({open, openOnchange, selectedTicket}:
    {open: boolean, openOnchange: (open: boolean) => void, selectedTicket: SupportTicket}) => {
        const handleDeleteTicket = () => {
            ...
            showErrorToast("Ticket deleted failed", "Please try again.");
        }
    return ( 
        <>
                    ...
                    <DialogDescription>
                        <div className="flex flex-col p-8">
                            ...
                            <div className="flex flex-row w-full gap-4 justify-center">
                                ...
                                <Button onClick={handleDeleteTicket} variant="default" className="bg-red-600 text-white cursor-pointer w-[48%] h-[52px]">Delete</Button>
                            </div>
                        </div>
                    </DialogDescription>
                </DialogContent>
