...
const ResendInviteModal = ({open, openOnchange, selectedUser}:
    ...
    return ( 
        ...
        <Dialog open={open} onOpenChange={openOnchange}>
            <DialogPortal>
                <DialogTitle className="hidden">Resend Invite</DialogTitle>
                ...
                <DialogContent className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white w-[580px] rounded-lg shadow-lg">
                    <DialogDescription>
                        <div className="flex flex-col p-8">
                            ...
                            <Image src="/resend-invite.png" alt="delete-ticket" width={240} height={240} />
                            </div>
                            <p className="m-0 text-2xl font-bold">Resend Admin Invite</p>
                            <p className="text-sm m-0 mb-6">Send a new invitation to the admin to grant access.</p>
                            <p className="text-lg font-semibold mb-6">Do you want to resend the invite to Admin {selectedUser?.firstName} {selectedUser?.lastName}?</p>
                            <div className="flex flex-row w-full gap-4 justify-center">
                                ...
                                <Button onClick={handleSendInvite} variant="default" className="bg-red-600 text-white cursor-pointer w-[48%] h-[52px]">Resend Invite</Button>
                            </div>
                        </div>
                    </DialogDescription>
                </DialogContent>
