...
const DeleteUserModal = ({open, openOnchange, selectedUser}:
                ...
                <DialogContent className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white w-[580px] rounded-lg shadow-lg">
                    <DialogDescription>
                        <div className="flex flex-col p-8">
                            ...
                            <p className="text-sm m-0 mb-6">Deleting an admin will permanently remove their access. To restore access, you'll need to send them a new invitation.</p>
                            <p className="text-lg font-semibold mb-6">Are you sure you want to permanently delete {selectedUser?.firstName} {selectedUser?.lastName}?</p>
                            <div className="flex flex-row w-full gap-4 justify-center">
                                ...
                                <Button onClick={handleDeleteUser} variant="default" className="bg-red-600 text-white cursor-pointer w-[48%] h-[52px]">Delete</Button>
                            </div>
                        </div>
                    </DialogDescription>
                </DialogContent>
