...
const DeactivateUserModal = ({open, openOnchange, selectedUser}:
                ...
                <DialogContent className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white w-[580px] rounded-lg shadow-lg">
                    <DialogDescription>
                        <div className="flex flex-col p-8">
                            ...
                            <Image src="/deactivate-user.png" alt="delete-ticket" width={240} height={240} />
                            </div>
                            <p className="m-0 text-2xl font-bold">Deactivate Admin User</p>
                            <p className="text-sm m-0 mb-6">Deactivating an admin will temporarily suspend their access. You can reactivate their account at any time if access is  needed again.</p>
                            <p className="text-lg font-semibold mb-6">Are you sure you want to deactivate Admin {selectedUser?.firstName} {selectedUser?.lastName}?</p>
                            <div className="flex flex-row w-full gap-4 justify-center">
                                ...
                                <Button onClick={handleDeactivateUser} variant="default" className="bg-red-600 text-white cursor-pointer w-[48%] h-[52px]">Deactivate Admin</Button>
                            </div>
                        </div>
                    </DialogDescription>
                </DialogContent>
