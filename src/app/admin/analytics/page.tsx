...
const AnalyticsPage = () => {
  return (
    <div className="flex-1 min-h-0 flex flex-col gap-8">
      ...
      <ScrollArea className="min-h-0 pr-[15px]">
        <div className="flex flex-col gap-8">
          ...
          <section className="min-h-0 flex-1 flex flex-col gap-8 rounded-xl border border-border-secondary bg-white shadow-2xs">
            <AnalyticsTabs />
          </section>
          <FooterBar className="bg-blue- 500" />
        </div>
      </ScrollArea>
    </div>
  );
